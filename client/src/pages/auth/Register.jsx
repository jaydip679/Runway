...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Registration state is now held in Redis, user needs to verify OTP
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex items-center justify-center">
        ...
        <div className="px-4 text-sm text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900 absolute">or sign up with</div>
      </div>
