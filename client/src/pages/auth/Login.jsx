  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        {successMsg && <div style={{ color: 'var(--success)', fontSize: '14px', background: 'var(--success-bg)', padding: '8px 12px', borderRadius: '4px' }}>{successMsg}</div>}
      ...
      <Button variant="secondary" fullWidth onClick={handleGoogleLogin} className="google-btn">
